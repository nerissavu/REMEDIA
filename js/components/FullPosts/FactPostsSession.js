...
$template.innerHTML = /*html*/ `
    ...
    <div class="site-content">
        ...
        <div class="posts">
            <h1 id="type" class="heading">Fact</h1>
            <!--pagination-->
...
export default class FactPostsSession extends HTMLElement {
    constructor() {
        super();
    ...
    static get observedAttributes() {
        return ['type','source','image','date','author','content'];
    }
...
window.customElements.define('fact-posts-session', FactPostsSession)