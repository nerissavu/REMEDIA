        ...
        <div class="posts">
            ...
            <div class="post-content" data-aos="zoom-in" data-aos-delay="400">
                <div class="post-title">
                    ...
                    <br />
                    <div style='font: 700 1rem/1.2 "Poppins";
                    color: #20b2aa;'><time id="date"></time></div>
...
export default class PostsSession extends HTMLElement {
    constructor() {
        super();
...
window.customElements.define('posts-session', PostsSession)